...
class ClassroomMessagesController extends Controller
{
    ...
    {
        //add sellected can muse mutitimes but select one time if used multiline take latest one
        //ms vs me for margin left and right bootstrap
...
//        event(new MessageSentEvent($message));
        MessageSentEvent::broadcast($message)->toOthers();
